    ...
    <div className="boxCoaching flex column center">
      ...
      <div className="coaching1 flex shadowLight responsiveCoaching">
        <div className="boxCoachingImg">
          <img
            className="imgCoaching margin"
            src={imgPositive}
            alt="Intervención Emocional"
          />
        </div>
        <div className="descriptionCoaching">
          ...
          <p>
            ...
            método eficaz y corto, aprenderás a gestionar tu vida con nuevas
            herramientas, liberándote de ataduras para siempre.
          </p>
        </div>
      </div>
      ...
      <div className="coaching2 flex paddingTop shadowLight responsiveCoaching revers">
        <div className="descriptionCoaching">
          ...
          <p>
            ...
            vida llena y brillante. Este enfoque te permitirá encontrar tu
            potencial y convertirte en el dueño de tu vida. Los procesos son
            eficaces, cortos y no te hacen dependiente del Coach, permitiéndote
            aprender a gestionar tu vida con nuevas herramientas. ¡Deja que el
            Coaching Emocional sea tu guía hacia una vida plena y satisfactoria!
          </p>
        </div>
        <div className="boxCoachingImg">
          <img
